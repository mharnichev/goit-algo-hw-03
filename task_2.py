...
# що випали випадковим чином і в певному діапазоні під час чергового тиражу. Наприклад, необхідно вгадати шість чисел від 1 до 49 чи п'ять чисел від 1 до 36 тощо.
...
def get_numbers_ticket(min, max, quantity):
    if (
        min < 1 or max > 1000 or
        min > max or quantity < 1 or 
        quantity > (max - min + 1)): 
        return []
